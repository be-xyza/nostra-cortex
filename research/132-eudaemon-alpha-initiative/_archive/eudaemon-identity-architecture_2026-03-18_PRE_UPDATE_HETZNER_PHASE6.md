...
- **Emergent** (Stage 1-2): The institution exists as a declared entity with a charter but limited operational capability. The ZeroClaw agent acts on its behalf.
...
Runtime: ZeroClaw (minimal orchestration)
```
...
|-------|---------------|---------|-------------------|
| 1: External Research | `agent:eudaemon-alpha-01` | ZeroClaw on VPS | `Emergent` |
| 2: Multi-Agent | `agent:eudaemon-alpha-{N}` | Specialized ZeroClaw agents | `Emergent` |
