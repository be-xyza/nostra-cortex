...
- Read-only heap list/delta visibility has passed. Context bundling, heap emission, workflow/proposal projection, provider cognition, polling, and execution remain later gates.
