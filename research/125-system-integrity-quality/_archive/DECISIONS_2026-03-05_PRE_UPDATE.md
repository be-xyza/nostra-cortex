...
**Decision**: SIQ fields exposed via contribution-graph overview are optional metadata only (legacy `initiative-graph` alias stays backward compatible if still present).
