...
## DEC-119-009: Cargo Gate Remains a Hard Closure Blocker Until Dependency Path Is Normalized
**Date**: 2026-02-18
**Status**: ✅ Decided
...
2. yanked dependency chain (`nostra-test-kit -> ic-agent 0.45 -> keccak 0.1.5`) is removed or locked to non-yanked resolution.
