...
- [x] Resolve frontend workspace compile blockers (dependency/module parity and API mismatch fixes).
- [x] Re-run `cargo check --manifest-path /Users/xaoj/ICP/nostra/Cargo.toml -p frontend` successfully.
