...
- Scope delivered for v1 (`L0-L2` runtime support, `L3/L4` fail-closed).
- Lifecycle emission, replay artifacts, and authority/evaluation integration implemented and validated in `cortex-desktop`.
- Remote sink behavior shipped with staged rollout controls (best-effort default, fail-closed optional).
