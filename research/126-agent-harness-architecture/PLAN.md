...
KARL is retained here as an external pattern source for multi-capability evaluation framing and trajectory semantics, not as approval for direct RL deployment in the harness.
