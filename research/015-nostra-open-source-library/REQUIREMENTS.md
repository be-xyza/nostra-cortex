...
|-----------|------------|---------|---------|
| Workflow Engine | Nostra Workflow | existing | Ingestion and analysis pipelines |
| Storage | Selection pending | selection pending | Storing repo metadata and analysis results (KG) |

### Frontend
| Component | Technology | Version | Purpose |
|-----------|------------|---------|---------|
| Visualization | Selection pending | selection pending | Visualizing the idea-technology map |
| Interface | React + adapter candidate | selection pending | User interface for the playground |
