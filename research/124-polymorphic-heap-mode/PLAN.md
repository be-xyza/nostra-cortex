---
id: "124"
name: "polymorphic-heap-mode"
title: "Initiative 124 Plan Lock: Polymorphic Heap Source, Web Parity Rollout"
type: "plan"
project: "nostra"
status: active
...
stewardship:
  ...
  domain: "Cortex Runtime"
created: "2026-02-24"
updated: "2026-02-24"
---

# Initiative 124 Plan Lock: Polymorphic Heap Source, Web Parity Rollout
...
1. Boundary: Nostra defines heap governance/state intent; Cortex executes heap runtime/projection behavior.
2. Determinism: heap projection outputs are contract-locked and tested for stable semantics across hosts.
3. Host parity: desktop remains canonical implementation in this phase and web remains a parity consumer.
