...
- [ ] Add `schema_registry.toml` as an index over existing paths.
...
- [ ] Choose the ontology encoding approach: minimal JSON-LD subset or custom JSON manifest.
- [ ] Define core vocabulary for `Space`, `Contribution`, `Relation`, `Capability`, and `ProvenanceScope`.
...
- [ ] Define versioning and compatibility rules for ontology changes.
- [ ] Define extension rules for Space-local vocabulary additions.
- [ ] Define what counts as a breaking ontology change.
- [ ] Document how ontology terms map to existing constitutional types.
- [ ] Add examples for at least two Space vocabularies.
...
- [ ] Define the `KnowledgeBundle` manifest structure.
...
- [ ] Define a sample bundle for one real Space.
...
- [ ] Define request and response contracts for triple-style queries.
...
- [ ] Complete the schema inventory and registry index skeleton.
- [ ] Draft the minimal ontology vocabulary and extension rules.
