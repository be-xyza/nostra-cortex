...
External pattern sources now include KARL for multi-capability evaluation and trajectory semantics, and MASFactory for governed workflow-draft and graph-observability patterns.
