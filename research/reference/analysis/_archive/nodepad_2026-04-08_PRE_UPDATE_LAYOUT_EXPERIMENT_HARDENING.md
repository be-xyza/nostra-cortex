...
|-----------------|---------------|--------|
| Multi-View Canvas (Graph/Tiling) | A2UI Heap Mode / Cosmic Graph | Conceptual (Initiatives 124, 075) |
| Background Semantic Linking | Eudaemon Graph Traversal | Conceptual |
| 14-Type Classification | Contribution Ontology | Missing (Gap targeted by Ontology strategy) |
...
1. **Extract Grid Algorithm**: Port Nodepad's spatial BSP grid layout into a standalone A2UI Lit component or React component.
2. **Background Synthesis Prototype**: Create a Cortex background workflow that mimics Nodepad's auto-linking and synthesis, applying it to a generic Space graph of Contributions.
3. **Ontology Mapping**: Compare Nodepad's 14 base note types with our current structural `Contribution` and `Block` schemas.
