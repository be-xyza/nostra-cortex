...
reference_assets:
  - "research/reference/topics/data-knowledge/awesome-ontology"
...
## Placement
- Destination: `research/reference/topics/data-knowledge/awesome-ontology`
- Registration mode: lightweight reference anchor with local README plus analysis artifacts.
...
- Treat the repository itself as a registered landscape reference, not as an exhaustive intake matrix or dependency batch.
