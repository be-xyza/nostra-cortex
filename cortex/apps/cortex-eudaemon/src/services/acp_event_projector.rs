...
fn format_projection(kind: &NostraProjectionKind) -> &'static str {
    match kind {
        ...
        NostraProjectionKind::AgentBranched => "agent_branched",
        NostraProjectionKind::ToolCallCompleted => "tool_call_completed",
    }
}
...
pub fn to_domain_update_kind(kind: AcpSessionUpdateKind) -> DomainSessionUpdateKind {
    match kind {
        ...
        AcpSessionUpdateKind::AgentBranching => DomainSessionUpdateKind::AgentBranching,
        AcpSessionUpdateKind::ToolCallResult => DomainSessionUpdateKind::ToolCallResult,
    }
}
...
fn from_domain_projection_kind(kind: DomainProjectionKind) -> NostraProjectionKind {
    match kind {
        ...
        DomainProjectionKind::AgentBranched => NostraProjectionKind::AgentBranched,
        DomainProjectionKind::ToolCallCompleted => NostraProjectionKind::ToolCallCompleted,
    }
}
...
fn from_domain_update_kind(kind: DomainSessionUpdateKind) -> AcpSessionUpdateKind {
    match kind {
        ...
        DomainSessionUpdateKind::AgentBranching => AcpSessionUpdateKind::AgentBranching,
        DomainSessionUpdateKind::ToolCallResult => AcpSessionUpdateKind::ToolCallResult,
    }
}
