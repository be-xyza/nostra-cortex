...
mod tests {
    ...
    #[test]
    fn migrate_provider_registry_state_promotes_legacy_runtime_provider_alias_into_binding_and_discovery() {
        let legacy_provider = ProviderRuntimeSettings {
            ...
            credential_binding_id: Some("cred_openrouter_primary".to_string()),
        ...
        let legacy_credential = ProviderCredentialBinding {
            credential_binding_id: "cred_openrouter_primary".to_string(),
            provider_id: LEGACY_PROVIDER_ID.to_string(),
