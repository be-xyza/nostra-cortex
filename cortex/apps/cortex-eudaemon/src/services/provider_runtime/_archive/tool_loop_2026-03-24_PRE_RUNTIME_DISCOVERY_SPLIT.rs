use crate::services::provider_runtime::client::{LlmAdapterClient, LlmStreamEvent};
...
mod tests {
    use super::*;
    use crate::services::provider_runtime::config::{LlmAdapterConfig, LlmAdapterFailMode};
