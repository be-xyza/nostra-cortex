...
import {
  ...
  ordinal,
  sum
} from "./chunk-A4EBGI3B.js";
import {
  drag_default,
  transform,
  zoom_default
} from "./chunk-MOTL2LOU.js";
import {
  select_default
} from "./chunk-GAJKR2NF.js";
...
function overRest(func, start, transform3) {
  ...
  return function() {
    var args = arguments, index6 = -1, length = nativeMax4(args.length - start, 0), array = Array(length);
    while (++index6 < length) {
      array[index6] = args[start + index6];
    }
    index6 = -1;
...
function baseSlice(array, start, end) {
  ...
  while (++index6 < length) {
    result2[index6] = array[index6 + start];
  }
  return result2;
}
...
function setToArray(set2) {
  var index6 = -1, result2 = Array(set2.size);
...
function baseUnset(object, path) {
  ...
  while (++index6 < length) {
    ...
    if (key === "constructor" && index6 + 1 < length && typeof path[index6 + 1] === "string" && path[index6 + 1] === "prototype") {
      if (isRootPrimitive && index6 === 0) {
        continue;
      }
      return false;
    }
...
function baseRange(start, end, step, fromRight) {
  var index6 = -1, length = nativeMax12(nativeCeil4((end - start) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
    result2[fromRight ? length : ++index6] = start;
    start += step;
  }
  return result2;
}
...
function getDagDepths(_ref, idAccessor) {
  ...
  var nodeDepths = Object.assign.apply(Object, [{}].concat(_toConsumableArray3(Object.entries(graph).filter(function(_ref4) {
    ...
    var _ref7 = _slicedToArray2(_ref6, 2), id = _ref7[0], node = _ref7[1];
    ...
    tickFrame: function tickFrame(state) {
      ...
      function paintLinks() {
        ...
        Object.entries(linksPerColor).forEach(function(_ref) {
          var _ref2 = _slicedToArray2(_ref, 2), color = _ref2[0], linksPerWidth = _ref2[1];
      ...
      function paintArrows() {
        ...
        state.graphData.links.filter(getVisibility).forEach(function(link) {
          ...
          var bzLine = link.__controlPoints && _construct(Bezier, [start.x, start.y].concat(_toConsumableArray3(link.__controlPoints), [end.x, end.y]));
      ...
      function paintPhotons() {
        ...
        state.graphData.links.filter(getVisibility).forEach(function(link) {
          ...
          var bzLine = link.__controlPoints ? _construct(Bezier, [start.x, start.y].concat(_toConsumableArray3(link.__controlPoints), [end.x, end.y])) : null;
