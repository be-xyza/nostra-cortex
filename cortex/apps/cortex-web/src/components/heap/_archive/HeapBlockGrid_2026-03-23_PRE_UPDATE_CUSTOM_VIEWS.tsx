            ...
            <div className="heap-block-grid flex h-full w-full bg-cortex-surface-base overflow-hidden relative">
                ...
                <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar relative z-10 bg-transparent">
                    ...
                    <header id="heap-grid-header" className="min-h-[56px] flex items-center justify-between px-4 py-3 sticky top-0 z-30 flex-wrap gap-3 glass-panel backdrop-blur-xl rounded-none shadow-sm border-b border-white/5">
                        <div className="flex items-center gap-3 flex-wrap min-w-0">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="mt-1 flex flex-wrap gap-2 text-[10px] uppercase tracking-[0.24em] text-cortex-400">
                                    <span className="rounded-full border border-white/8 bg-white/[0.03] px-2 py-1 text-cortex-300/80">
                        ...
                        <div className="flex items-center gap-1.5 rounded-full border border-white/8 bg-white/[0.03] p-1.5 shadow-sm backdrop-blur-sm">
                            <button
                            ...
                            >
                                ...
                                {settingsOpen && (
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-[22rem] max-w-[calc(100vw-1rem)] overflow-hidden rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.98),rgba(2,6,23,0.96))] shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-200">
                                            ...
                                            <div className="relative p-3.5">
                                                <div className="flex items-start justify-between gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className="rounded-full border border-white/10 bg-white/[0.04] px-2 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-cortex-200"
                                                    >
                                                        Close
                                                    </button>
                                                </div>
                                                ...
                                                <div className="mt-3 space-y-2.5">
                                                    {EXPLORE_VIEW_SETTING_SECTIONS.map((section) => (
                                                        <div key={section.id} className="rounded-2xl border border-white/10 bg-white/[0.03] p-2.5">
                                                            <div className="flex items-start justify-between gap-3">
                                                                <div>
                                                ...
                                                <div className="mt-3 flex items-center justify-between gap-3">
                                                    <button
                                                        ...
                                                        className="rounded-full border border-white/10 bg-white/[0.03] px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-cortex-200"
                                                    >
                                                        Reset overrides
                                                    </button>
                            ...
                            {loading ? (
                                ...
                                <div className={`relative w-full ${exploreSettings.layoutMode === "compact" ? "pt-5 pb-12 px-4" : exploreSettings.layoutMode === "open" ? "pt-8 pb-16 px-6" : "pt-6 pb-14 px-5"}`}>
                                    {derivedViews.length > 0 && (
                                        <section className="mb-4 rounded-2xl border border-white/6 bg-white/[0.03] px-4 py-4 shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-sm">
...
function ExploreSettingsGroup({
    ...
    return (
        <div className="rounded-2xl border border-white/8 bg-white/[0.03] p-2.25">
