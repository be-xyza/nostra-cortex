              ...
              <div className="grid grid-cols-1 gap-4 px-5 py-5 md:grid-cols-2 xl:grid-cols-3">
                {groupProviders.map((provider) => {
                  ...
                  <article
                    ...
                    className={[
                      "panel group relative cursor-pointer overflow-hidden border-white/8 transition-all duration-300",
                    ...
                    <div className="panel-body space-y-4">
                      ...
                      <div className="grid gap-2 text-xs">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-ink">{formatProviderCredentialState(provider)}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-ink-muted">Readiness</span>
                          <span className="text-ink">{readiness.detail}</span>
                        </div>
                      </div>
                      ...
                      {selectedProviderId === provider.id ? (
                        ...
                        <p className="pt-1 text-[10px] text-ink-faint">Open details</p>
                      )}
                    </div>
                  </article>
                  );
