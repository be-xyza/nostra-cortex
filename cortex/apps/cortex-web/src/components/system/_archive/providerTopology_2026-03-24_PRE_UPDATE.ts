...
export function formatProviderModelLabel(provider: Pick<ProviderRecord, "defaultModel" | "supportedModels">): string {
  return provider.defaultModel?.trim() || provider.supportedModels?.[0] || "Not configured";
}
