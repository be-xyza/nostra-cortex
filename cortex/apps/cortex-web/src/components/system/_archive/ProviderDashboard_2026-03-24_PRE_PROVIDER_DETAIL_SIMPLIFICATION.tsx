...
import { resolveAdapterStatusError } from "./providerDiagnostics.ts";
                  ...
                  <div className="space-y-5">
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="grid gap-2 text-sm">
                        <span className="text-white/55">Default binding</span>
                        <div className="rounded-2xl border border-white/10 bg-white/[0.04] px-3 py-2.5 text-sm text-white/78">
                          {selectedProvider && (selectedProvider.bindingIds ?? []).includes("llm.default")
                            ? "llm.default"
                            : "Not bound"}
                        </div>
                      </div>
                      ...
                      <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4">
                        ...
                        <div className="mt-3 grid gap-2 text-sm text-white/68">
                          <div className="flex items-center justify-between gap-3">
                            ...
                            <span className="text-right text-white/88">
                              {(selectedProvider.bindingIds ?? []).includes("llm.default") ? "llm.default" : "Not bound"}
                            </span>
                          </div>
                          <div className="flex items-center justify-between gap-3">
                            <span>Locality</span>
