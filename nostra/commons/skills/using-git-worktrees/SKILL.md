...
Check what files exist to understand the environment, but do NOT automatically install dependencies.
...
If the user specifically asks you to install dependencies, you may do so then.

### 4. Verify Clean Baseline

Run tests to ensure worktree starts clean if dependencies are already met:
...
| No package.json/Cargo.toml | Verify environment but skip install unless asked |
...
[Verify environment and setup tests if requested]
...
- Auto-detect project files to verify environment
