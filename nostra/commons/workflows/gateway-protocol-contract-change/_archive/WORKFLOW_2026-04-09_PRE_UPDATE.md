...
## Self-Improvement
- If the same endpoint families churn repeatedly, split route ownership into narrower gateway workflows.
- If parity drift recurs without real behavior changes, tighten fixture generation or contract derivation automation.
