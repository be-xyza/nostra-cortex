...
## Self-Improvement
- If the same authority surfaces repeatedly drift, create a narrower dedicated workflow.
- If repo-contract checks miss common regressions, extend the authority schema or check script.
