...
## Self-Improvement
- If the same slot or promotion rules keep churning, split out narrower navigation workflows.
- If host-local ordering keeps reappearing, tighten the navigation authority checks or docs.
