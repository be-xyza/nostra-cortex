...
## Self-Improvement
- If the same governance surface keeps changing, spin out a narrower operational workflow.
- If checks stay green while behavior drifts, add a stronger validator or benchmark hook.
