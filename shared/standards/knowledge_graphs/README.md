...
3. Phase E internal read-model contracts for graph topology handoff and retrieval benchmarking.
4. Phase F internal operational artifacts for graph pilot execution and evidence emission.
...
- `explore_topology_view.schema.json`
...
- `/Users/xaoj/ICP/shared/standards/knowledge_graphs/examples/explore/research_space_topology_view_v1.json`
- `/Users/xaoj/ICP/shared/standards/knowledge_graphs/examples/explore/research_agent_topology_view_v1.json`
...
## Phase F Operational Artifacts

- `/Users/xaoj/ICP/logs/knowledge/graph_pilot_benchmark_latest.json`
- `/Users/xaoj/ICP/logs/knowledge/graph_pilot_comparison_latest.json`
- `/Users/xaoj/ICP/logs/knowledge/graph_pilot_shared_evaluation_latest.json`
- `/Users/xaoj/ICP/logs/knowledge/graph_pilot_topology_latest.json`
- `/Users/xaoj/ICP/scripts/run_knowledge_graph_pilot.sh`
- `/Users/xaoj/ICP/scripts/check_cortex_eudaemon_default_build.sh`
...
9. `explore_topology_view.schema.json` is an internal read-model contract for `136` and remains derived from the canonical triple facade rather than a new source of truth.
10. Versioned JSON artifacts are discoverable alongside schemas, but remain a separate contract class from `.schema.json` files.
11. Phase F graph pilot artifacts are operational evidence only; they do not replace the ontology, bundle, triple query, or Explore topology contracts as the canonical graph commons surfaces.
12. The shared evaluation artifact records case-aligned comparison against the current `037` knowledge path; it is an operational evidence surface, not a new contract authority.
...
bash /Users/xaoj/ICP/scripts/run_knowledge_graph_pilot.sh
bash /Users/xaoj/ICP/scripts/check_cortex_eudaemon_default_build.sh
