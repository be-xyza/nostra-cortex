...
| [antigravity_rule_policy.toml](./antigravity_rule_policy.toml) | `.toml` | Antigravity policy for skill replacement and governance handling. |
...
| [antigravity_rule_dispositions.json](./antigravity_rule_dispositions.json) | versioned JSON | Disposition registry for antigravity rule handling. |
...
7. Discovery documentation must stay in sync with the actual `shared/standards/` tree.
