...
6. Example fixtures exist to prove the ontology and bundle schemas can carry realistic Space-local contracts.
7. Versioned JSON artifacts are discoverable alongside schemas, but remain a separate contract class from `.schema.json` files.
