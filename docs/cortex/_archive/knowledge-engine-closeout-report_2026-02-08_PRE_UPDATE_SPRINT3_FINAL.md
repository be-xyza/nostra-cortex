...
> **Last Updated**: 2026-02-08 (Sprint 3 continuation)
...
| Quality uplift | `Recall@10` + `nDCG@10` >= 20% vs baseline | pass | Gate summary shows `uplift_recall_pct=92.31`, `uplift_ndcg_pct=109.54` |
...
- Latest gate artifact: `/Users/xaoj/ICP/logs/knowledge/knowledge_closeout_gate_summary_latest.json` (`generated_at=2026-02-08T05:15:38Z`).
- Latest rollback artifact: `/Users/xaoj/ICP/logs/knowledge/rollback_drill_latest.json`.
- Latest blocking test-evidence run: `/Users/xaoj/ICP/logs/testing/runs/local_ide_phase_next_20260208T050821Z.json`.
- Latest testing gate artifact: `/Users/xaoj/ICP/logs/testing/test_gate_summary_latest.json` (`overall_verdict=ready`).
