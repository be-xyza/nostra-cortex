...
echo "== workflows registry sync"
bash "$ROOT_DIR/scripts/run_repo_python.sh" "$ROOT_DIR/scripts/sync_workflows_registry.py" --mode install
...
bash "$ROOT_DIR/scripts/run_repo_python.sh" "$ROOT_DIR/tests/test_quick_validate_registry_asset.py"
